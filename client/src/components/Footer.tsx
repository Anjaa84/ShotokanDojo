    ...
    <footer className="bg-secondary text-light">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="mb-6 text-white/80">
              Dedicated to teaching traditional Shotokan Karate since 2015. We
              provide martial arts education for all ages in a respectful,
              disciplined environment.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://www.facebook.com/profile.php?id=61564291512707"
                className="text-white/80 hover:text-accent transition duration-300"
                aria-label="Facebook"
              >
          ...
          <div>
            ...
            <p className="mb-4 text-white/80">
              Subscribe to our newsletter for karate tips, event updates, and
              exclusive content.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700 text-center text-white/80">
          <p>
            © {new Date().getFullYear()} Shotokan Karate Academy. All rights
            reserved.
          </p>
        </div>
      </div>
