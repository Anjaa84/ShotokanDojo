    ...
    <section id="contact" className="py-16 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="font-heading text-secondary text-3xl md:text-4xl font-bold mb-4">Contact Us</h2>
          <div className="section-divider"></div>
          <p className="text-foreground max-w-3xl mx-auto">
            Have questions about our programs or ready to start your karate journey? Get in touch with us.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-2/3 bg-white rounded-lg shadow-md p-8">
            <h3 className="font-heading text-secondary text-2xl font-bold mb-6">Send Us a Message</h3>
